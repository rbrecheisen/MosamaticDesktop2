    ...
    def load(self, model_dir, model_version):
        ...
        for f in os.listdir(model_dir):
            ...
            if f == f'model-{str(model_version)}.zip':
                ...
                # model.save('D:\\model_unzipped.keras')
                ...
                model = keras.models.load_model('/Users/ralph/Desktop/downloads/tensorflowmodelfiles/model_unzipped.keras')
                ...
                # contour_model.save('D:\\contour_model_unzipped.keras')
                ...
                contour_model = keras.models.load_model('/Users/ralph/Desktop/downloads/tensorflowmodelfiles/contour_model_unzipped.keras')
