...
class FileModel(BaseModel):
    ...
    fileset_model: Mapped['FileSetModel'] = relationship('FileSetModel', back_populates='file_models')
    fileset_model_id: Mapped[str] = Column('_filesetmodel_id', ForeignKey('_filesetmodel._id'))
